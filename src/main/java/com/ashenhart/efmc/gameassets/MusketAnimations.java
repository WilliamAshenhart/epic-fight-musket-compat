...
public class MusketAnimations {
    ...
    public static AnimationAccessor<ComboAttackAnimation> CEREMONIAL_MUSKET_AUTO_1;
    public static AnimationAccessor<ComboAttackAnimation> CEREMONIAL_MUSKET_AUTO_2;
    public static AnimationAccessor<ComboAttackAnimation> CEREMONIAL_MUSKET_AUTO_3;
    ...
    public static AnimationAccessor<ComboAttackAnimation> MUSKET_AUTO_1;
    public static AnimationAccessor<ComboAttackAnimation> MUSKET_AUTO_2;
    ...
    public static AnimationAccessor<ComboAttackAnimation> BAYONET_AUTO;
    ...
    public static AnimationAccessor<ComboAttackAnimation> DUAL_PISTOL_AUTO1;
    public static AnimationAccessor<ComboAttackAnimation> DUAL_PISTOL_AUTO2;
    ...
    public static AnimationAccessor<ComboAttackAnimation> CEREMONIAL_PISTOL_AUTO_1;
    public static AnimationAccessor<ComboAttackAnimation> CEREMONIAL_PISTOL_AUTO_2;
    public static AnimationAccessor<ComboAttackAnimation> CEREMONIAL_PISTOL_AUTO_3;
    public static AnimationAccessor<DashAttackAnimation> CEREMONIAL_PISTOL_DASH;
    public static AnimationAccessor<ComboAttackAnimation> PISTOL_AUTO_1;
    public static AnimationAccessor<ComboAttackAnimation> PISTOL_AUTO_2;
    public static AnimationAccessor<ComboAttackAnimation> PISTOL_AUTO_3;
    ...
    public static void build(AnimationManager.AnimationBuilder builder) {
        ...
        CEREMONIAL_MUSKET_AUTO_1 = builder.nextAccessor("biped/combat/ceremonial_musket_auto_1", (accessor) ->
                new ComboAttackAnimation(0.1F, 0.3F, 0.5F, 0.7F, null, Armatures.BIPED.get().toolR, accessor, Armatures.BIPED)
        ...
        CEREMONIAL_MUSKET_AUTO_2 = builder.nextAccessor("biped/combat/ceremonial_musket_auto_2", (accessor) ->
                new ComboAttackAnimation(0.1F, 0.2F, 0.4F, 0.7F, null, Armatures.BIPED.get().toolR, accessor, Armatures.BIPED)
                        .addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED,2.1F));
        CEREMONIAL_MUSKET_AUTO_3 = builder.nextAccessor("biped/combat/ceremonial_musket_auto_3", (accessor) ->
                new ComboAttackAnimation(0.1F, 0.3F, 0.5F, 0.6F, null, Armatures.BIPED.get().toolR, accessor, Armatures.BIPED)
                        .addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED,2.1F));
        ...
        MUSKET_SHOT = builder.nextAccessor("biped/combat/musket_shot", (accessor) -> new ReboundAnimation(0.05F, accessor, "biped/combat/musket_shot_mid", "biped/combat/musket_shot_up", "biped/combat/musket_shot_down", "biped/combat/musket_shot_lying", Armatures.BIPED));
        ...
        BAYONET_AUTO = builder.nextAccessor("biped/combat/bayonet_auto", (accessor) ->
                new ComboAttackAnimation(0.1F, 0.4F, 0.6F, 0.7F, null, Armatures.BIPED.get().toolR, accessor, Armatures.BIPED)
        ...
        MUSKET_AUTO_1 = builder.nextAccessor("biped/combat/musket_auto_1", (accessor) ->
                new ComboAttackAnimation(0.1F, 0.5F, 0.6F, 0.8F, null, Armatures.BIPED.get().toolR, accessor, Armatures.BIPED)
        ...
        MUSKET_AUTO_2 = builder.nextAccessor("biped/combat/musket_auto_2", (accessor) ->
                new ComboAttackAnimation(0.1F, 0.3F, 0.4F, 0.8F, null, Armatures.BIPED.get().toolR, accessor, Armatures.BIPED)
                        .addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED,1.7F));
        ...
        PISTOL_SHOT = builder.nextAccessor("biped/combat/pistol_shot", (accessor) -> new ReboundAnimation(0.05F, accessor, "biped/combat/pistol_shot_mid", "biped/combat/pistol_shot_up", "biped/combat/pistol_shot_down", "biped/combat/pistol_shot_lying", Armatures.BIPED));
        ...
        DUAL_PISTOL_SHOT = builder.nextAccessor("biped/combat/dual_pistol_shot", (accessor) -> new ReboundAnimation(0.05F, accessor, "biped/combat/dual_pistol_shot_mid", "biped/combat/dual_pistol_shot_up", "biped/combat/dual_pistol_shot_down", "biped/combat/dual_pistol_shot_lying", Armatures.BIPED));
        ...
        OFFHAND_SHOT = builder.nextAccessor("biped/combat/offhand_shot", (accessor) -> new ReboundAnimation(0.05F, accessor, "biped/combat/offhand_shot_mid", "biped/combat/offhand_shot_up", "biped/combat/offhand_shot_down", "biped/combat/offhand_shot_lying", Armatures.BIPED));
        DUAL_PISTOL_AUTO1 = builder.nextAccessor("biped/combat/dual_pistol_auto1", (accessor) ->
                new ComboAttackAnimation(0.1F, 0.2F, 0.4F, 0.6F, null, Armatures.BIPED.get().toolR, accessor, Armatures.BIPED)
                        .addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED,2.1F));
        DUAL_PISTOL_AUTO2 = builder.nextAccessor("biped/combat/dual_pistol_auto2", (accessor) ->
                new ComboAttackAnimation(0.1F, 0.3F, 0.4F, 0.8F, null, Armatures.BIPED.get().toolL, accessor, Armatures.BIPED)
                        .addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED,2.1F));
        ...
        CEREMONIAL_PISTOL_AUTO_2 = builder.nextAccessor("biped/combat/ceremonial_pistol_auto_2", (accessor) ->
                new ComboAttackAnimation(0.1F, 0.2F, 0.3F, 0.6F, null, Armatures.BIPED.get().toolR, accessor, Armatures.BIPED)
        ...
        CEREMONIAL_PISTOL_AUTO_3 = builder.nextAccessor("biped/combat/ceremonial_pistol_auto_3", (accessor) ->
                new ComboAttackAnimation(0.1F, 0.3F, 0.4F, 0.6F, null, Armatures.BIPED.get().toolR, accessor, Armatures.BIPED)
                        .addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED,2.6F));
        ...
        SCOPE_SHOT = builder.nextAccessor("biped/combat/scope_shot", (accessor) -> new ReboundAnimation(0.05F, accessor, "biped/combat/scope_shot_mid", "biped/combat/scope_shot_up", "biped/combat/scope_shot_down", "biped/combat/scope_shot_lying", Armatures.BIPED));
        KNEEL_SCOPE = builder.nextAccessor("biped/living/kneel_scope", (accessor) -> new StaticAnimation(true, accessor, Armatures.BIPED));
        SNEAK_SCOPE = builder.nextAccessor("biped/living/sneak_scope", (accessor) -> new MovementAnimation(true, accessor, Armatures.BIPED));
