...
public class MusketColliderPreset {
    ...
    public static final Collider MUSKET = registerCollider(ResourceLocation.fromNamespaceAndPath(Epic_fight_musket_compat.MODID, "musket"), new MultiOBBCollider(3, 0.4D, 0.7D, 0.4D, 0D, -0.5D, 0D));
}