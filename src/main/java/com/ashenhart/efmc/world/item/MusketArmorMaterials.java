...
public class MusketArmorMaterials {
    public static final Holder<ArmorMaterial> MUSKETEER_UNIFORM = register("musketeer_uniform",
            ...
            }), 16, 2f, 0.1f, () -> Items.LEATHER);


    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection,
                                                  int enchantability, float toughness, float knockbackResistance,
                                                  Supplier<Item> ingredientItem) {
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(Epic_fight_musket_compat.MODID, name);
