...
public class Animations {
    ...
    public static void build(AnimationManager.AnimationBuilder builder) {
        ...
        MUSKET_AUTO_2 = builder.nextAccessor("biped/combat/musket_auto_2", (accessor) ->
                new BasicAttackAnimation(0.2F, 0.3F, 0.5F, 0.8F, null, Armatures.BIPED.get().toolR, accessor, Armatures.BIPED)
                        .addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED,2.7F));
